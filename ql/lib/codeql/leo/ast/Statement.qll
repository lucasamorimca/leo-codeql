...
class Stmt extends AstNode, @leo_stmt {
  ...
  /**
   * Gets all child statements recursively
   */
  Stmt getAChildStmt() {
    result = this.getAChild().(Stmt) or
    result = this.getAChild().(Stmt).getAChildStmt()
  }
...
class BlockStmt extends Stmt {
  ...
  /**
   * Gets all expressions in this block recursively
   */
  Expr getAnExpr() {
    ...
    result = this.getAStatement().(AssertStmt).getCondition() or
...
class AssertStmt extends Stmt {
  ...
  /**
   * Gets the assertion condition
   */
  Expr getCondition() { result = this.getAChild().(Expr) }
